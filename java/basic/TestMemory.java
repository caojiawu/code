...
public class TestMemory {
    ...
    public static void testMemoryAllocate(){
        Integer a1 = 33;
        Integer a2 = 33;
        System.out.println(a1==a2); //True. Integer类型取值在[-128,127]范围，常量池中分配并查找一个已经存在的对象

        Integer b1 = 330;
        Integer b2 = 330;
        System.out.println(b1==b2); //False. Integer类型取值不在[-128,127]范围，常量池中直接创建一个新的对象
        ...
        System.out.println(d1==d2); //True. 对于在常量池中分配的字符串，直接查找已经存在的对象并返回.
